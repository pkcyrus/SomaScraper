...
import soma.async.PlaylistExportTask;
import soma.async.ScrapeChannelsTask;
import soma.async.WritePlaylistTask;
import soma.async.ZipPlaylistExportTask;
import soma.data.SomaDBOpenHelper;
...
import static soma.ui.ControllerLaunch.ControllerState.BROWSE;
...
public class ControllerLaunch {
    ...
    private SomaDBOpenHelper dbHelper;
    ...
    private void startScrapeTask(Channel channel){
        ScrapeChannelsTask sct = new ScrapeChannelsTask(channel);
